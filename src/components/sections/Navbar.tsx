  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-transparent px-8 py-5 md:px-16 flex items-center justify-between">
      ...
      <div className="flex-1 flex justify-end items-center gap-6">
        <Link href="/login" className="text-sm font-body text-white/50 hover:text-white transition-colors">
          LOG IN
        </Link>
        <Link href="/start" className="bg-white text-black rounded-full px-5 py-2 text-sm font-body font-medium hover:scale-105 active:scale-95 transition-transform">
          START FREE
        </Link>
      </div>
    </nav>
